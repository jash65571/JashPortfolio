...
| [`barbershop/`](barbershop/) | Neon Fade Barber & Color Bar — bold maximalist concept | ✅ Built |
| [`restaurant-casual/`](restaurant-casual/) | The Corner Table — casual neighborhood restaurant concept | ✅ Built |
